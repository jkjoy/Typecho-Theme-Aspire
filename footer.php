<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
	...
	<div class="o-grid">
		<div class="o-grid__col o-grid__col--4-4-s o-grid__col--1-3-m o-grid__col--1-3-l o-grid__col--2-4-m o-grid__col--1-4-l ">
			<h2></h2><a href="<?php $this->options->siteUrl(); ?>" class="u-block u-font-regular"><?php $this->options->title(); ?></a>
			<p>
			...
			<ul class="c-footer-list o-plain-list">
				<?php $this->widget('Widget_Metas_Category_List')->to($category); ?>
                    ...
                    <li class="c-nav__item">
						<a class="c-nav__link" href="<?php $category->permalink(); ?>" title="<?php $category->name(); ?>">
							<?php $category->name(); ?>
						</a>
					</li>
                    <?php endwhile; ?>
